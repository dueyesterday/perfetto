...
export interface SettingsBindings {
  ...
  // Per-tab enable/disable of one setting, independent of the global state.
  // Lets a tab turn a filter off (or on) without affecting /settings or other
  // tabs. The merged effective settings drop per-tab-disabled entries.
