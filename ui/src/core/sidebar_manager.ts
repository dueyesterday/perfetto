...
const SIDEBAR_COLLAPSED_KEY = 'pfSidebarCollapsed';
...
export class SidebarManagerImpl implements SidebarManager {
  ...
  // When collapsed, the sidebar renders as a narrow icon-only rail. The state
  // persists across reloads (it's a per-user layout preference).
  private _collapsed = loadCollapsed();
  private lastId = 0;
  ...
  public toggleCollapsed() {
    ...
    try {
      localStorage.setItem(SIDEBAR_COLLAPSED_KEY, this._collapsed ? '1' : '0');
    } catch (e) {
