                ...
                ? [
                    ...
                    m(SortableTable, {
                      columns: [
                        {
                          label: 'Size',
                          sortKey: (r: BitmapListRow) => r.pixelCount,
                        ...
                        },
                        {
                          ...
                          sortKey: (r: BitmapListRow) => r.row.shallowJava,
                          render: (r: BitmapListRow) =>
                            m(
                              'span',
                              {class: 'ah-mono'},
                              fmtSize(r.row.shallowJava),
                            ),
                        },
                        {
                          label: 'Shallow Native',
                          align: 'right' as const,
                          sortKey: (r: BitmapListRow) => r.row.shallowNative,
                          render: (r: BitmapListRow) =>
                            m(
                              'span',
                              {class: 'ah-mono'},
                              fmtSize(r.row.shallowNative),
                            ),
                        },
                        {
                          label: 'Retained',
                          align: 'right' as const,
                          sortKey: (r: BitmapListRow) => {
                            let j = 0;
                            for (const h of r.row.retainedByHeap) j += h.java;
                            return j;
                          },
                          render: (r: BitmapListRow) => {
                            let j = 0;
                        ...
                        },
                        {
                          ...
                          align: 'right' as const,
                          sortKey: (r: BitmapListRow) =>
                            r.row.reachableSize ?? 0,
                          render: (r: BitmapListRow) =>
                            r.row.reachableSize === null
                              ? m(
                                  'span',
                                  {class: 'ah-mono ah-opacity-60'},
                                  '\u2026',
                                )
                              : m(
                                  'span',
                                  {class: 'ah-mono'},
                                  fmtSize(r.row.reachableSize),
                                ),
                        },
                        {
                          ...
                          align: 'right' as const,
                          sortKey: (r: BitmapListRow) =>
                            r.row.reachableNative ?? 0,
                          render: (r: BitmapListRow) =>
                            r.row.reachableNative === null
                              ? m(
                                  'span',
                                  {class: 'ah-mono ah-opacity-60'},
                                  '\u2026',
                              ...
                              : m(
                                  'span',
                                  {class: 'ah-mono'},
                                  fmtSize(r.row.reachableNative),
                                ),
                        },
                        {
                          label: 'Object',
                          sortKey: (r: BitmapListRow) => r.row.className,
                          render: (r: BitmapListRow) =>
                            m(InstanceLink, {
                              row: r.row,
                              navigate,
